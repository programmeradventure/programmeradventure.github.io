var Language = {
    ...
    api:{
           ...
           api_func:[
                ...
                {category:"Object",name:"undead",desc:"если true - то объект бессмертный"},
                {category:"Object",name:"placeGround",desc:"(только для типа 'ground') запрещает размещать объекты типа 'ground'"},
                {category:"Object",name:"placeItem",desc:"(только для типа 'ground') запрещает размещать объекты типа 'item'"},
                {category:"Object",name:"placeMoved",desc:"(только для типа 'ground') запрещает размещать объекты типа 'moved'"},
